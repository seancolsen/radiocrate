...
export default function SidebarLeft(props: {
  ...
  const scrimOpacity = drawerVisible
  ...
  const panel = (
    <aside
      ...
      className="bg-panel border-edge flex h-full flex-col border-r"
  ...
  if (!persistent) {
    return (
      <>
        ...
        <div
          aria-hidden="true"
          className={cx("absolute inset-0 bg-black", {
            "pointer-events-none": !drawerVisible,
          })}
          style={{
